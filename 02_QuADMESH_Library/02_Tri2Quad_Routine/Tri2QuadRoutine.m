...
CM  = CHILmesh([newMesh.ConnectivityList;...        % Append triangles below quads.
    CM.ConnectivityList(:,[1,1:3])],newMesh.Points,CM.GridName);
